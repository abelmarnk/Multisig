...
impl FractionalThreshold {
    ...
    pub fn greater_than_or_equal(&self, numerator: u64, denominator: u64) -> Result<bool> {
        ...
        Ok((numerator).checked_mul(u64::from(self.denominator)).ok_or(ProgramError::ArithmeticOverflow)?
            .ge(&denominator.checked_mul(u64::from(self.numerator)).ok_or(ProgramError::ArithmeticOverflow)?))
    }
    ...
    pub fn threshold_greater_than_or_equal(&self, threshold:&FractionalThreshold) -> Result<bool> {
        ...
        self.greater_than_or_equal(u64::from(threshold.numerator),
